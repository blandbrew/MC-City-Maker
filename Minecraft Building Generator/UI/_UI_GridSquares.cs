...
namespace Minecraft_Building_Generator.UI
{
    ...
    class _UI_GridSquares : GridMap_ViewModel
    {

        public (int, int) ParentContainerArrayCoordinate { get; set; }
        public (int, int) SquareArrayCoordinate { get; set; }
        ...
        //public UI_GridSquares(double x, double y, Color color, Color fillcolor)
        //{
        //    X = x;
        //    Y = y;
